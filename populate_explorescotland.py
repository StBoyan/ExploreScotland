...
def populate():
    ...
    levels = {1: {"topic": "Glasgow", "content": "Glasgow has a reputation of being an industrial city, but also in the past used to be a  natural location for fishing.
              ...
              Additionally, it is home to some artists well known in the UK such as Franz Ferdinand and Belle & Sebastian."
              ,"numOfQuestions": 5},
              ...
              It's a city that captures the imagination.J.K. Rowling wrote the first Harry Potter books in Edinburgh cafes.
              ...
              ,"numOfQuestions": 5},
              3: {"topic": "Loch Ness", "content": "Loch Ness is magical place to visit.
              ...
              "numOfQuestions": 5},
              4: {"topic": "Dundee", "content": "Dundee (Scottish Gaelic: Dùn Dèagh) is the fourth-largest city in Scotland.
              ...
              Two very important places should be remembered when visiting Dundee.
