...
def populate():
    ...
    levels = {1: {"topic": "Glasgow", "content": "<h1>Glasgow</h1><img src =\"https://peoplemakeglasgow.com/images/Clydeside1.jpg\"</br><p>Glasgow has a reputation of being an industrial city, but also in the past used to be a  natural location for fishing.</p>\
              ...
              <p>Additionally, it is home to some artists well known in the UK such as Franz Ferdinand and Belle & Sebastian.</p>","numOfQuestions": 5},
              ...
              <p>You can run up and down the grassy ruined rooms or just sit peacefully on the stone ramparts,</p> watching the wind ruffle waves on Loch Ness.</p>", "numOfQuestions": 5},

              4: {"topic": "Dundee", "content":"<h1>Dundee</h1><img src=\"https://www.eveningtelegraph.co.uk/wp-content/uploads/sites/11/2017/02/Winter-Driving-Routes-credit-VisitScotland-4Dundee.jpg-960x575.jpg\"<p>Dundee (Scottish Gaelic: Dùn Dèagh) is the fourth-largest city in Scotland.</p>"
              ...
              <p>Keiller's marmalade became a famous brand because of its mass production and its worldwide export.</p>", "numOfQuestions": 5},
              ...
              <p>Aberdeen is a host of Aberdeen International Youth Festival, a major international event of young performers.</p>" ,"numOfQuestions": 5},
             ...
             <p>In 1297, William Wallace had a small force, but he lured English knights across Stirling Bridge,</p><p> split their army, and won the day.\</p></br><p>Robert the Bruce, King of the Scots, set the scene for the English army to get bogged down, literally, at Bannockburn.</p>\
              ...
              <p>The moto of the city is Bon Accord, which means good agreement and has been used in the past as a password for entering the city.</p>" ,"numOfQuestions": 5}}
